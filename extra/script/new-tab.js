...
async function main() {
  ...
  if (feed) {
    ...
    await Promise.all([
      ...
      loadTextBox('block3', entry, 'block 3'),
      loadTextBox('block4', entry, 'block 4'),
      loadTextBox('block5', entry, 'block 5'),
      loadTextBox('block6', entry, 'block 6'),
      loadTextBox('block7', entry, 'block 7'),
      loadTextBox('block8', entry, 'block 8')
    ]);
